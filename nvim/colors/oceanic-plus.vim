  ...
  " OceanicPlus
  " Author: Luka Saric
  " Inspired by VSCode OceanicPlus theme
  " Modified Mike Hartington/OceanicNext theme codebase
  " ===============================================================
  ...
  " {{{ Setup
    ...
    let g:colors_name="oceanic-plus"
  " }}}
  " {{{ Italics
    let g:oceanic_plus_terminal_italic = get(g:, 'oceanic_plus_terminal_italic', 0)
    let s:italic = ""
    if g:oceanic_plus_terminal_italic == 1
      let s:italic = "italic"
    endif
  "}}}
  " {{{ Bold
    let g:oceanic_plus_terminal_bold = get(g:, 'oceanic_plus_terminal_bold', 0)
    let s:bold = ""
    if g:oceanic_plus_terminal_bold == 1
     let s:bold = "bold"
    endif
  "}}}
  " {{{ Colors
  ...
  call s:hi('TSVariable',                         s:softyellow, '',       '',          '')
  ...
  call s:hi('TSConstBuiltin',                     s:orange, '',       '',          '')
  call s:hi('TSConstant',                         s:softyellow, '',       '',          '')
  call s:hi('TSException',                        s:purple, '',       '',          '')

  call s:hi('cssColor',                           s:cyan,   '',       '',          '')
  call s:hi('cssBraces',                          s:cyan, '',       '',          '')
  call s:hi('cssClassName',                       s:purple, '',       '',          '')

  call s:hi('scssTSVariable',                     s:softyellow, '',       '',          '')

  call s:hi('vueTSTag',                           s:red, '',       '',          '')
  call s:hi('vueTSTagAttribute',                  s:purple, '',       '',          '')
  call s:hi('vueTSText',                          s:base07, '',       '',          '')
  call s:hi('vueTSTagDelimiter',                  s:cyan, '',       '',          '')
  call s:hi('vueTSPunctSpecial',                  s:cyan, '',       '',          '')
  call s:hi('vueTSOperator',                      s:cyan, '',       '',          '')
  call s:hi('vueTSMethod',                        s:purple, '',       '',          '')
  ...
  call s:hi('typescriptClassExtends',             s:green, '',       '',          '')
  call s:hi('typescriptClassName',                s:yellow,   '',       '',          '')
  call s:hi('typescriptDecorator',                s:blue,   '',       '',          '')
  call s:hi('typescriptIdentifier',               s:red,   '',       '',          '')
  call s:hi('typescriptIdentifierName',           s:softyellow,   '',       '',          '')
  call s:hi('typescriptObjectLabel',              s:base07,   '',       '',          '')
  call s:hi('typescriptBlock',                    s:softyellow,   '',       '',          '')
  call s:hi('typescriptDestructureVariable',      s:softyellow,   '',       '',          '')
  call s:hi('typescriptProp',                     s:softyellow,   '',       '',          '')
  call s:hi('typescriptProperty',                 s:softyellow,   '',       '',          '')
  call s:hi('typescriptMember',                   s:softyellow,   '',       '',          '')
  call s:hi('typescriptGlobal',                   s:yellow,   '',       '',          '')
  call s:hi('typescriptArrayMethod',              s:blue,   '',       '',          '')
  call s:hi('typescriptObjectMethod',             s:blue,   '',       '',          '')
  call s:hi('typescriptPromiseStaticMethod',      s:blue,   '',       '',          '')
  call s:hi('typescriptImport',                   s:purple,   '',       '',          '')
  call s:hi('typescriptExport',                   s:purple,   '',       '',          '')
  call s:hi('typescriptCastKeyword',              s:purple,   '',       '',          '')
  call s:hi('typescriptAliasDeclaration',         s:base07,   '',       '',          '')
  call s:hi('typescriptVariable',                 s:purple,   '',       '',          '')
  call s:hi('typescriptClassHeritage',            s:green,   '',       '',          '')
  call s:hi('typescriptClassExtends',             s:purple,   '',       '',          '')
  call s:hi('typescriptCall',                     s:orange,   '',       '',          '')
  call s:hi('typescriptFuncType',                 s:orange,   '',       '',          '')
  call s:hi('typescriptMethodAccessor',           s:purple,   '',       '',          '')
  call s:hi('typescriptClassBlock',               s:blue,   '',       '',          '')
  call s:hi('typescriptStatementKeyword',         s:purple,   '',       '',          '')
  call s:hi('typescriptBinaryOp',                 s:cyan,   '',       '',          '')
  call s:hi('typescriptOperator',                 s:cyan,   '',       '',          '')
  call s:hi('typescriptDotNotation',              s:cyan,   '',       '',          '')
  call s:hi('typescriptTypeReference',            s:base07,   '',       '',          '')
  call s:hi('typescriptTypeParameter',            s:base07,   '',       '',          '')
  call s:hi('typescriptArray',                    s:softyellow,   '',       '',          '')
  call s:hi('typescriptAssign',                   s:cyan,   '',       '',          '')
  call s:hi('typescriptBraces',                   s:cyan,   '',       '',          '')
  call s:hi('typescriptArrowFuncArg',             s:orange,   '',       '',          '')
  call s:hi('typescriptTestGlobal',               s:softyellow,   '',       '',          '')
  call s:hi('typescriptArrowFunc',                s:purple,   '',       '',          '')
  call s:hi('typescriptFuncTypeArrow',            s:purple,   '',       '',          '')
  call s:hi('typescriptTypeAnnotation',           s:cyan,   '',       '',          '')
  call s:hi('typescriptEndColons',                s:cyan,   '',       '',          '')
  call s:hi('typescriptTypeQuery',                s:cyan,   '',       '',          '')
  call s:hi('typescriptMemberOptionality',        s:cyan,   '',       '',          '')
  call s:hi('typescriptOptionalMark',             s:cyan,   '',       '',          '')
  call s:hi('typescriptPredifinedType',           s:yellow,   '',       '',          '')
  call s:hi('typescriptTypeBrackets',             s:cyan,   '',       '',          '')
  call s:hi('typescriptObjectLiteral',            s:softyellow,   '',       '',          '')
  call s:hi('typescriptBOMWindowMethod',          s:blue,   '',       '',          '')
  call s:hi('typescriptUnaryOp',                  s:cyan,   '',       '',          '')
  call s:hi('typescriptExceptions',               s:purple,   '',       '',          '')
  call s:hi('typescriptCacheMethod',              s:blue,   '',       '',          '')
  call s:hi('typescriptVariableDeclaration',      s:softyellow,   '',       '',          '')
  call s:hi('typescriptPaymentShippingOptionProp',s:softyellow,   '',       '',          '')
  call s:hi('typescriptHeadersMethod',            s:blue,   '',       '',          '')
